    ...
    private static OperationPlan BuildPlan()
    {
        return new OperationPlan
        {
            ...
            [
                new PlannedAction(
                    SourcePath: "/a",
                    SourceResult: SourceResult.Copied,
                ...
                new PlannedAction(
                    ...
                    DestinationResult: DestinationResult.Overwritten,
                    NumberOfFilesAffected: 1,
                    NumberOfFoldersAffected: 0,
                    InputBytes: 10,
                    OutputBytes: 10),
                new PlannedAction(
                    SourcePath: "/c",
                    SourceResult: SourceResult.Moved,
                ...
                new PlannedAction(
                    SourcePath: "/d",
                    SourceResult: SourceResult.Deleted,
                    DestinationPath: null,
                    DestinationResult: DestinationResult.None,
                    NumberOfFilesAffected: 1,
                    NumberOfFoldersAffected: 0,
                    InputBytes: 10,
                    OutputBytes: 10),
