...
public abstract class SelectionFromFileStepEditorViewModelBase : StepEditorViewModelBase
{
    ...
    protected SelectionFromFileStepEditorViewModelBase(IAppContext ctx)
    {
