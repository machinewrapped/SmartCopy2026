        ...
        IReadOnlyList<ValidationPairResult> pairs)
    {
        ...
        else
        {
            ...
            action = valuePairs > 0 && valuePasses > 0
                ? "Every pair cleared (no regression, nothing invalid) and the candidate bundle beats the legacy baseline beyond the gate on at least one pair. Safe to promote for the validated platform policy."
