...
### 3. `winget` — Windows Package Manager submission
...
### 4. `homebrew` — Homebrew tap update
...
Two secrets must be configured in the SmartCopy2026 repo (Settings → Secrets → Actions):
